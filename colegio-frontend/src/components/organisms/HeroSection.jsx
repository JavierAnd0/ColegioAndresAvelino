    ...
    return (
        ...
        >
            ...
            {hasSlides ? (
                ...
                /* Blobs de color cuando no hay slides */
                <>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-neutral-950 via-neutral-950/80 to-neutral-950/25 pointer-events-none z-10" />
            <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/90 via-transparent to-neutral-950/50 pointer-events-none z-10" />
            ...
            <div className="flex-1 flex items-center relative z-20">
                <div className="max-w-6xl mx-auto px-6 py-28 w-full">
                    <div className="max-w-2xl flex flex-col gap-8">
                        ...
                        {/* Título del colegio — siempre visible */}
                        ...
                        {/* Subtítulo del slide actual o el prop por defecto */}
                        <p className="animate-fade-in-up-d2 text-neutral-300 leading-relaxed"
                            style={{ fontSize: 'clamp(1rem, 1.5vw, 1.2rem)' }}>
                            {(hasSlides && slides[current]?.subtitle) || subtitle}
                        </p>
            ...
            {/* ── Indicadores (dots) ── */}
            {slides.length > 1 && (
                <div className="absolute bottom-24 left-1/2 -translate-x-1/2 z-30 flex items-center gap-1.5">
                    {slides.map((_, i) => (
                        <button
                            key={i}
                            onClick={() => goTo(i)}
            ...
            {slides.length > 1 && !paused && (
                <div className="absolute bottom-[4.5rem] left-0 right-0 z-30 h-0.5 bg-white/10">
                    <div
                        key={`${current}-bar`}
            ...
            {/* ── Accesos rápidos ── */}
            <div className="relative z-30 border-t border-white/[0.08] bg-neutral-950/65 backdrop-blur-md">
            ...
            {/* ── Wave de salida ── */}
            <div className="relative z-30 leading-[0]">
