...
function EventSlide({ event, isDragging }) {
    ...
    return (
        <div className="min-w-[280px] sm:min-w-[320px] snap-start flex-shrink-0 select-none">
            <Link
                href="/calendario"
                draggable={false}
            ...
            >
                <div className="relative bg-white rounded-2xl overflow-hidden
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                        ...
                        <h3 className="font-mono font-bold text-[0.95rem] text-neutral-900 leading-snug line-clamp-2
                            group-hover:text-neutral-600 transition-colors">
                            {title}
                        </h3>

                        {description && (
                            <p className="text-[0.8rem] text-neutral-400 leading-relaxed line-clamp-2 mt-1.5">
                                {description}
                            </p>
                        )}
            ...
            <section className="py-16 bg-neutral-50">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="flex gap-4 overflow-hidden">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="min-w-[320px] flex-shrink-0 animate-pulse">
